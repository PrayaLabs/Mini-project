...
public class pipeScalingUp : MonoBehaviour
{
    Vector3 lTemp;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            if (gameObject.GetComponent<Renderer>().material.color == collision.gameObject.GetComponent<Renderer>().material.color && collision.gameObject.name == "Pipe-dynamic")
            {
