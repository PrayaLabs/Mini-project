...
public class pipe_intermediate_scale_up : MonoBehaviour
{
    Vector3 lTemp;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            {
                level_logic.GetComponent<level_logic_1>().collided_top = true;
                level_logic.GetComponent<level_logic_1>().collision_top = collision.gameObject.name;
    ...
    private void OnCollisionExit(Collision collision)
    {
        ...
        level_logic.GetComponent<level_logic_1>().collided_top = false;
        level_logic.GetComponent<level_logic_1>().collision_top = "";
    }
