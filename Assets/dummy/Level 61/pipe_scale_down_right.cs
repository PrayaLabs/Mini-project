...
public class pipe_scale_down_right : MonoBehaviour
{
    Vector3 lTemp;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            {
                level_logic.GetComponent<levelLogic>().right_collided = true;
                level_logic.GetComponent<levelLogic>().right_collision = collision.gameObject.name;
    ...
    private void OnCollisionExit(Collision collision)
    {
        ...
        level_logic.GetComponent<levelLogic>().right_collided = false;
        level_logic.GetComponent<levelLogic>().right_collision = "";
    }
